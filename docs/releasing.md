...
5. Approve the `pypi` environment for that run only after reviewing the report, commit and hashes. The upload job downloads those exact artifacts by ID; it does not rebuild them.
