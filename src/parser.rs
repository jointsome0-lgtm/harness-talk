        ...
        .subcommand(
            Command::new("peer")
                ...
                .subcommand(
                    Command::new("add")
                        .disable_help_subcommand(true)
                        .about("Register an immutable session address.")
                .long_about("Save a peer name and exact session address. Existing names cannot be reassigned. Does not notify or launch a client.")
                        ...
                        .arg(Arg::new("harness")
                            .long("harness")
                            .help("Client that owns the session.")
                            .required(true)
